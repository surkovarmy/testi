	...
	<div id="container">
		...
		<form action="" class="form" method="GET">
          ...
          <div id="field4" class="field">
				...
				<div class="right">
                    <input type="checkbox" name="weight[]" id="field4-1" data-type="apple,samsung,iOS5,iOS6,android40,android42,white,black,blue,yellow" <?if (isset($_GET['weight']) && (in_isset_arr('140',$_GET['weight']))==true) echo "checked";?> value="140" class="140">
                    <span class="option-title">
                         до 140
                    </span>

                    <input type="checkbox" name="weight[]" id="field4-2" data-type="apple,samsung,sony,htc,iOS5,iOS6,android40,android41,android42,white,black,blue,yellow" <?if (isset($_GET['weight']) && (in_isset_arr('150',$_GET['weight']))==true) echo "checked";?> value="150" class="150">
                    <span class="option-title">
                         до 150
                    </span>
                
                    <input type="checkbox" name="weight[]" id="field4-3" data-type="apple,samsung,sony,htc,iOS5,iOS6,android40,android41,android42,white,black,blue,yellow" <?if (isset($_GET['weight']) && (in_isset_arr('160',$_GET['weight']))==true) echo "checked";?> value="160" class="160">
                    <span class="option-title">
                         до 160
                    </span>

                    <input type="checkbox" name="weight[]" id="field4-4" data-type="apple,samsung,sony,htc,iOS5,iOS6,android40,android41,android42,white,black,blue,yellow" <?if (isset($_GET['weight']) && (in_isset_arr('170',$_GET['weight']))==true) echo "checked";?> value="170" class="170">
                    <span class="option-title">
                         до 170
                    </span>


                    <input type="checkbox" name="weight[]" id="field4-5" data-type="apple,samsung,sony,htc,iOS5,iOS6,android40,android41,android42,white,black,blue,yellow" <?if (isset($_GET['weight']) && (in_isset_arr('180',$_GET['weight']))==true) echo "checked";?> value="180" class="180">
                    <span class="option-title">
                         до 180
                    </span>
					
					 <input type="checkbox" name="weight[]" id="field4-6" data-type="apple,samsung,sony,htc,nokia,iOS5,iOS6,win,android40,android41,android42,white,black,blue,yellow" <?if (isset($_GET['weight']) && (in_isset_arr('190',$_GET['weight']))==true) echo "checked";?> value="190" class="190">
                    <span class="option-title">
                         до 190
                    </span>
				</div> <!--end right -->
